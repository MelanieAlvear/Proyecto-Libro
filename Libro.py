...
def main():
    libro1 = Libro(id=1, codigo="NCT977", titulo="The Great Gatsby", autor=" F. Scott Fitzgerald", disponible=True, cantidad_disponible=4, tipo_pasta="Dura")
    print(libro1)
    libro2 = Libro(id=2, codigo="SVT137", titulo="El principito", autor="Antoine de Saint-Exupéry", disponible=True, cantidad_disponible=2, tipo_pasta="Dura")
    print(libro2)
